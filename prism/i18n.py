...
STRINGS = {
    ...
    "discover_competitors": {"zh-TW": "✨ 自動生成", "en": "✨ Auto-generate"},
    "generate_key_areas": {"zh-TW": "✨ 自動生成", "en": "✨ Auto-generate"},
    "gen_keywords": {"zh-TW": "✨ 10 個關鍵字", "en": "✨ 10 Keywords"},
    "gen_keywords_from_areas": {"zh-TW": "✨ 生成關鍵詞", "en": "✨ Generate keywords"},
    ...
    "setup_key_areas_label": {"zh-TW": "重點領域", "en": "Key areas"},
    "setup_key_areas_hint": {"zh-TW": "3-5 個您希望品牌佔據的核心內容/主題領域，每行一個", "en": "3-5 key content/topic areas you want the brand to own — one per line"},
    "setup_key_areas_placeholder": {"zh-TW": "例如：企業級資安、零信任架構、合規與風險管理", "en": "e.g. Enterprise security, Zero-trust architecture, Compliance & risk management"},
    ...
    # --- visibility report PDF descriptions ---
    "visibility_desc": {"zh-TW": "品牌在 {n} 個提問共 {total} 次評估中被提及的比例", "en": "Share of {total} evaluations across {n} prompts where the brand was mentioned"},
    "evaluations_desc": {"zh-TW": "所有追蹤提問 × 已啟用引擎的總執行次數", "en": "Total runs across all tracked prompts × enabled engines"},
    "citations_desc": {"zh-TW": "AI 答案引擎在回答中引用的來源總數", "en": "Total unique sources AI answer engines cited in responses"},
    "competitors_desc": {"zh-TW": "在同一提問中與您品牌一同被提及的競爭者數量", "en": "Number of competing brands mentioned alongside yours in the same prompts"},
    "prompts_desc": {"zh-TW": "系統正在追蹤的搜尋提問數量", "en": "Number of search prompts the system is tracking"},
    "zero_visibility": {"zh-TW": "零曝光", "en": "0% visibility"},
    "visibility_section_desc": {"zh-TW": "共 {n} 個追蹤提問，其中 {visible} 個提問出現了您的品牌。零曝光提問以紅色標記。", "en": "{n} tracked prompts — your brand appeared in {visible} of them. Zero-visibility prompts are highlighted in red."},
    "sov_section_desc": {"zh-TW": "共 {total} 次提及，分佈於 {brands} 個品牌。您的品牌以藍色背景標記。", "en": "{total} total mentions across {brands} brands. Your brand is highlighted in blue."},
    "citations_section_desc": {"zh-TW": "來自 {domains} 個不同網域的 {total} 次引用，涵蓋 {pages} 個頁面。", "en": "{total} citations from {domains} unique domains, across {pages} cited pages."},
    "engines_section_desc": {"zh-TW": "數據分佈於 {count} 個答案引擎。", "en": "Data distributed across {count} answer engines."},
    "gaps_section_desc": {"zh-TW": "共 {n} 個競爭者出現但您的品牌缺席的提問 — 這些是最高回報的優化目標。", "en": "{n} prompts where competitors appear but your brand does not — these are the highest-ROI optimization targets."},
