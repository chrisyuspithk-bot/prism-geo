...
_T = {
    "zh-TW": {
        ...
        "kpi_visibility_desc": "{n} 個提問共 {total} 次評估中被提及的比例",
        "kpi_prompts": "追蹤提問",
        "kpi_runs": "總評估數",
        "kpi_citations": "引用來源數",
        "kpi_title": "關鍵指標",
    ...
    "en": {
        ...
        "kpi_visibility_desc": "Share of {total} evaluations across {n} prompts mentioning the brand",
